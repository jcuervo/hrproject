...
set :deploy_to,     '/home/rivereo/recruit'
set :application,   'recruit'
set :repository,    'git://github.com/mrrussellong/hrproject.git'
set :use_sudo,      false
...
namespace :deploy do
  ...
  task :reset_db do
    run "cd #{current_path} && rake db:migrate VERSION=0 && rake db:migrate"
  end
end
